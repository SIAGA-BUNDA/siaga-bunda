        ...
        <div class="bg-[#C1CFA1] rounded-xl border-[#C1CFA1] border-2 py-3">
          <form action="<?= BASEURL ?>pageAdmin/tambahArtikel" method="POST" enctype="multipart/form-data">
            ...
            <div class="border-[#C1CFA1]">
              <!-- Judul Artikel -->
              <input type="text" name="judul_artikel" placeholder="  Buat judul artikel..."
                class="w-full my-0 border-b border-[#C1CFA1] text-sm p-2 outline-none" required>

              <!-- Drag and Drop Image Upload -->
              <div id="drop-area"
                class="relative flex flex-col items-center justify-center w-full h-48 border-[#C1CFA1] border-2 bg-gray-50 my-4">
                <input type="file" name="image" id="file-input" class="absolute inset-0 opacity-0 cursor-pointer"
                  accept=".jpg,.jpeg,.png,.gif,.svg" onchange="previewFile(event)" required>
              ...
              <!-- Isi Artikel -->
              <textarea name="isi_artikel" placeholder="  Ketik artikel anda di sini..." rows="10"
                class="w-full my-0 border-b border-[#C1CFA1] text-sm p-2 outline-none resize-none" required>
              </textarea>
          ...
          <table class="min-w-full border-collapse border border-gray-300 rounded-lg bg-white">
            <thead class="bg-gray-100">
              <tr>
                ...
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Judul Artikel
                </th>
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Isi Artikel
                </th>
                      ...
                      <div class="relative p-4 w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                          ...
                          <div class="p-4 md:p-5 text-center">
                            ...
                            <p class="mb-5 text-md font-normal text-gray-500 dark:text-gray-400">Artikel yang dihapus
                              tidak
          ...
          <table class="min-w-full border-collapse border border-gray-300 rounded-lg bg-white">
            <thead class="bg-gray-100">
              <tr>
                ...
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Isi laporan
                </th>
          ...
          <table class="min-w-full border-collapse border border-gray-300 rounded-lg bg-white">
            <thead class="bg-gray-100">
              <tr>
                ...
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Isi Komentar
                </th>
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Waktu</th>
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Action</th>
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Status</th>
          ...
          <table class="min-w-full border-collapse border border-gray-300 rounded-lg bg-white">
            <thead class="bg-gray-100">
              <tr>
                ...
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">No. Telepon
                </th>
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">LMP</th>
                <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Tinggi Badan
                </th>
              </tr>
            </thead>
