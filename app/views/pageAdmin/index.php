...
?>
    <tr>
        ...
        <td>
            ...
            <div id="popup-modal-<?= $artikel_id ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                <div class="relative p-4 w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal-<?= $artikel_id ?>">
                        ...
                        <div class="p-4 md:p-5 text-center">
                            ...
                            <h3 class="mb-2 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this article?</h3>
                            <p class="mb-5 text-md font-normal text-gray-500 dark:text-gray-400">Artikel yang dihapus tidak dapat dikembalikan!</p>
                            ...
                            <form method="POST" action="<?= BASEURL ?>pageAdmin/hapusArtikel">
                                ...
                                <button data-modal-hide="popup-modal-<?= $artikel_id ?>" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                    No, cancel
                                </button>
                            </form>
                        </div>
            ...
            <table class="min-w-full border-collapse border border-gray-300 rounded-lg bg-white">
              <thead class="bg-gray-100">
                <tr>
                  ...
                  <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Isi Postingan</th>
                  <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Waktu</th>
                  <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Action</th>
                  <th class="border border-gray-300 px-4 py-2 text-left text-sm font-medium text-gray-600">Status</th>
                </tr>
              ...
              <tbody>
                ...
                echo'<tr>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">' . $laporan['LAPORAN_ID']; echo '</td>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">'. $laporan['ISI_LAPORAN']; echo '</td>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">'. $data['isiPostingan'][$i]; echo '</td>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">'. $laporan['WAKTU']; echo '</td><td class="border border-gray-300 px-5 py-2 text-sm text-gray-800 flex items-center justify-center">';?>
                  ...
                  <!-- Unique modal for each article -->
                  <div id="popup-modal-<?= $postingan_id ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                      <div class="relative p-4 w-full max-w-md max-h-full">
                          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                              <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal-<?= $postingan_id ?>">
                                  <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                  </svg>
                                  <span class="sr-only">Close modal</span>
                              ...
                              <div class="p-4 md:p-5 text-center">
                                  ...
                                  <h3 class="mb-2 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this komentar?</h3>
                                  ...
                                  <form method="POST" action="<?= BASEURL ?>pageAdmin/hapusLaporanPostingan">
                                      ...
                                      <button data-modal-hide="popup-modal-<?= $postingan_id ?>" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                          No, cancel
                                      </button>
                                  </form>
                              </div>
                  ...
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">'. $laporan['STATUS_LAPORAN']; echo '</td>';
                  echo'</tr>';
                  $i++;
                }
                  ?>
            ...
            <table class="min-w-full border-collapse border border-gray-300 rounded-lg bg-white">
              ...
              <tbody>
                ...
                echo'<tr>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">' . $laporan['LAPORAN_ID']; echo '</td>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">'. $laporan['ISI_LAPORAN']; echo '</td>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">'. $data['isiKomentar'][$i]; echo '</td>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">'. $laporan['WAKTU']; echo '</td><td class="border border-gray-300 px-5 py-2 text-sm text-gray-800 flex items-center justify-center">';?>
                  ...
                  <!-- Unique modal for each article -->
                  <div id="popup-modal-<?= $komentar_id ?>" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                      <div class="relative p-4 w-full max-w-md max-h-full">
                          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                              <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="popup-modal-<?= $komentar_id ?>">
                                  <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                  </svg>
                                  <span class="sr-only">Close modal</span>
                              ...
                              <div class="p-4 md:p-5 text-center">
                                  ...
                                  <form method="POST" action="<?= BASEURL ?>pageAdmin/hapusLaporanKomentar">
                                      ...
                                      <button data-modal-hide="popup-modal-<?= $komentar_id ?>" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                          No, cancel
                                      </button>
                                  </form>
                              </div>
