            ...
            <table class="min-w-full border-collapse border border-gray-300 rounded-lg bg-white">
              ...
              <tbody>
                ...
                echo'<tr>';
                  ...
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800">'. $laporan['WAKTU']; echo '</td>';
                  echo'<td class="border border-gray-300 px-4 py-2 text-sm text-gray-800"><button class="text-blue-600 hover:underline">Delete</button> | 
                  <button class="text-blue-600 hover:underline">Ignore</button> </td>';
