            ...
            <form action="<?= BASEURL ?>pageAdmin/tambahArtikel" method="POST">
              ...
              <div class="border-[#C1CFA1]">
                <input type="text" name="judul_artikel" placeholder="  Buat judul artikel..."
                  class="w-full my-0 border-b border-color text-sm p-2  outline-none">
                <textarea name="isi_artikel" placeholder="  Ketik artikel anda di sini..." rows="10"
                  class="w-full my-0 border-b border-color text-sm p-2 outline-none resize-none"></textarea>
                <div class="flex justify-center items-center ">
                  <button type="submit"
                    class="bg-[#4D5A32] text-white py-2 px-4 rounded-full shadow-lg hover:bg-green-950">
                    Kirim
                  </button>
            </form>
          </div>
