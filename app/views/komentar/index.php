<body class="bg-[#fdf6f1] min-h-screen p-10">
    ...
    <div class="w-full shadow-md mx-auto py-6 px-10 bg-[#ffff] rounded-xl ">
        ...
        <div class="space-y-6 ml-8">
            <div class="relative bg-white border-2 rounded-xl p-4 flex flex-col space-y-2">
        ...
        <div class="modal">
            <div class="modal-box">
                ...
                <div class="modal-action">
                    <label for="lapor-modal"
                        class="btn rounded-2xl bg-red-600 text-white hover:text-gray-800">Laporkan</label>
                    <label for="lapor-modal"
                        class="btn bg-gray-600 text-white hover:bg-gray-300 hover:text-gray-800 rounded-2xl">Tidak</label>
                </div>
            </div>
        </div>
</body>