<body class="bg-[#C1CFA1] flex items-center justify-center min-h-screen">
    ...
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-wd md:max-w-lg">
        ...
        <!-- Form -->
        <form action="<?=BASEURL?>resetPassword/submit_createPassword/<?=$data['token']?>" method="post">
            ...
            <div class="mb-4">
                ...
                <input name="password" type="password" id="password" placeholder="Buat Kata Sandi Baru Anda..." class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-[#C1CFA1] focus:border-[#C1CFA1]" value=<?= $data['password'] ?? '' ?>>
            ...
            <div class="mb-4">
                ...
                <input name="confirmPassword" type="password" id="password" placeholder="Konfirmasi Kata Sandi Anda..." class="mt-1 block w-full px-3 py-2 border <?= empty($data['errors']['password']) ? 'border-gray-300' : ' border-red-400' ?> rounded-lg focus:outline-none focus:ring-[#C1CFA1] focus:border-[#C1CFA1]" value=<?= $data['confirmPassword'] ?? '' ?>>
