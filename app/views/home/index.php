<div class="bg-[#C1CFA1] pt-[20px] pb-[69px] min-h-screen ">    
    ...
    <div class="bg-white mx-4 mt-2 sm:p-6 lg:p-8 rounded-3xl">
        <div class="flex justify items-center mt-10 relatif">
            ...
            <span>
                <h1 class="font-bold text-3xl text-[#4D5A32]">Selamat Datang Bunda!</h1>
                <br>
        ...
        <p class="font-semibold text-[#4D5A32] text-right mt- mr-4 px-4 pt-4 text-xl ml-auto w-max">Jelajahi setiap fitur pada Siaga Bunda</p>
        <div class="font-bold text-[#4D5A32] text-right mt-4 mr-4 px-4 pb-4 text-3xl hover:text-gray-300 transition-all duration-300 ml-auto w-max">
