<body class="bg-[#FCF1E6] pt-[20px] pb-[69px] min-h-screen">
    ...
    <div class="mx-4 sm:mx-6 lg:!mx-8 p-4 sm:p-6 lg:px-8 rounded-[35px] md:rounded-tr-none bg-white">
        ...
        <div class="flex justify-center my-8">
            <button id="calculateButton" class="relative flex items-center justify-center w-32 h-12 bg-gray-700 text-white rounded-2xl shadow-sm transform transition duration-300 hover:scale-110 hover:shadow-xl hover:bg-black cursor-pointer">
