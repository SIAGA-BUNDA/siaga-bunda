        ...
        <form action="<?= BASEURL ?>signUp/tambah" method="post">
            ...
            <div class="mb-4">
                ...
                <input name="nama" type="text" id="name" placeholder="Masukkan Nama Anda..."
                    class="mt-1 block w-full px-3 py-2 border <?= empty($data['errors']['nama']) ? 'border-gray-300' : 'border-red-400' ?> rounded-lg focus:outline-none focus:ring-[#C1CFA1] focus:border-[#C1CFA1]"
                    value=<?= $data['nama'] ?? '' ?>>
            ...
            <div class="mb-4">
                ...
                <input name="email" type="text" id="email" placeholder="Masukkan email anda..."
                    class="mt-1 block w-full px-3 py-2 border <?= empty($data['errors']['email']) ? 'border-grey-300' : ' border-red-400' ?>  rounded-lg focus:outline-none focus:ring-[#C1CFA1] focus:border-[#C1CFA1] "
                    value=<?= $data['email'] ?? '' ?>>
            ...
            <div class="mb-4">
                ...
                <input name="password" type="password" id="password" placeholder="Buat Kata Sandi Anda..."
                    class="mt-1 block w-full px-3 py-2 border <?= empty($data['errors']['password']) ? 'border-grey-300' : ' border-red-400' ?>  rounded-lg focus:outline-none focus:ring-[#C1CFA1] focus:border-[#C1CFA1]"
                    value=<?= $data['password'] ?? '' ?>>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="date" name="tanggal_lahir" id="birthdate"
                        class="mt-1 block w-full px-3 py-2 border <?= empty($data['errors']['tanggal_lahir']) ? 'border-grey-300' : ' border-red-400' ?>  rounded-lg focus:outline-none focus:ring-[#C1CFA1] focus:border-[#C1CFA1]"
            ...
            <div class="flex items-center justify-center">
                <button type="submit"
                    class=" w-40 bg-[#4D5A32] font-semibold text-white py-2 rounded-2xl hover:bg-white hover:text-[#4D5A32] hover:border-gray-300 hover:border focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 shadow-md">Daftar</button>
            </div>
        </form>
    </div>
